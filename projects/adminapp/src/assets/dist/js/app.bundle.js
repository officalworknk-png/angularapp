...
/* MULTIPLE MODAL OPEN BODY CLASS */
 ...
 if (mediaQuery.matches) {
	$(function() {
		if (navigator.userAgent.indexOf('Safari') != -1 && navigator.userAgent.indexOf('Chrome') == -1) {
			...
			$('.nav-menu li a').append('<b class="collapse-sign"><em class="fal fa-angle-down"></em></b>')
			$('.nav-menu li:first-child .collapse-sign, .nav-menu li:last-child .collapse-sign, .nav-menu li > ul li .collapse-sign').css({display:'none'});
		}
	  });
 }
...
var initApp = (function(app) {
	...
	app.resetSettings = function () {
		...
		if (myapp_config.debugState)
            ...
            localStorage.setItem("themeSettings", JSON.stringify({"themeOptions":"","themeURL":"assets/dist/css/themes/cust-theme-3.css"}));
			...
			.on('click touchend', '[data-action]', function(e) {
				...
				switch ( true ) {
					...
					case ( actiontype === 'theme-update' ):
						console.log("====Theme",'assets/dist/'+$(this).attr('data-theme'))
						initApp.updateTheme('assets/dist/'+$(this).attr('data-theme'), $(this).attr('data-themesave'));
